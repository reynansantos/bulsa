  ...
  return (
    <>
      ...
      <div style={{ position:"fixed", bottom:0, left:"50%", transform:`translateX(-50%) translateY(${vis?0:"110%"})`,
        width:"min(100vw, 420px)", maxWidth:420, background:C.surface, borderRadius:"26px 26px 0 0",
  ...
  return (
    <>
      ...
      <div style={{
        ...
        width:"min(100vw, 420px)", maxWidth:420, background:C.surface,
...
function ExpenseDetail({ expense, onClose, onEdit, onDelete, onAddPhoto }) {
  ...
  return (
    <>
      ...
      <div style={{ position:"fixed", bottom:0, left:"50%", transform:`translateX(-50%) translateY(${vis?0:"100%"})`, width:"min(100vw, 420px)", maxWidth:420, background:C.surface, borderRadius:"24px 24px 0 0", border:`1px solid ${C.border}`, borderBottom:"none", zIndex:301, transition:"transform 0.32s cubic-bezier(0.32,0.72,0,1)", overflow:"hidden" }}>
